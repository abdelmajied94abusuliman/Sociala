        ...
        <div className="postTop">
            <div className="postTopLeft flex">
              <div>
                ...
                <p className="postDate">{props.post.created_at}</p>
              </div>
              <div>
              {(props.post.user_id === current_ID) || (admin_group===current_ID) ?
                      <div id={`drpDwn${props.post.post_id}`} style={{ marginLeft: "18vw" , marginBottom : '6vh' }}>
                        <Dropdown>
                          <Dropdown.Toggle
                            variant="text-dark"
                            id="dropdown-basic"
                          ...
                          <Dropdown.Menu>
                            <div>
                              <Dropdown.Item
                                id={`editPostBTN${props.post.post_id}`}
                                onClick={() => {
                                  editPost(props.post.post_id);
                                }}
                              >
                                <BiEdit />
                                Edit
        ...
        <div className="postBottom">
          ...
          {likes.map((like, index_like) => {
              if (
                ...
                like.post_id === props.post.post_id
              ) {
            ...
            {flagLike === true ? (
              <form action="" onSubmit={removeLikePost}>
                <button
                  ...
                  onClick={() => handleLikePost(props.post.post_id)}
                  href="#!"
