...
export default function HomePost({ post }) {
  ...
  const deletePost = async (post_id , user_id) => {
    await axios
      .delete(`http://localhost:80/platform/react_project/posts.php/${post_id}/${user_id}`).then(window.location.assign('/home'))
      ...
      <div className="post">
        ...
        <div className="postWrapper">
          ...
          <div className="postTopLeft flex">
            ...
            <div id={`drpDwn${post.post_id}`} style={{ marginLeft: "39vw" , marginBottom : '6vh' }}>
              <Dropdown>
                <Dropdown.Toggle
                  variant="text-dark"
                  id="dropdown-basic"
                ...
                <Dropdown.Menu>
                  ...
                  <div>
                    <Dropdown.Item
                      variant="danger"
                      onClick={() => {
                        deletePost(post.post_id , post.id);
                      }}
                    >
                      <MdDeleteForever />
                      Delete
