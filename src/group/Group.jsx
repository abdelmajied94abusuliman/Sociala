                  ...
                  { pendingRequestGroups.map((element,index) => {
                          return (
                            <li className="sidebarFriend" key={index}>
                              ...
                              <span className="sidebarFriendName">{element.first_name}</span></a>
                              <Link>
                                <Button style={{marginLeft : '7vw'}} variant="primary" onClick={() => {acceptRequest(element.user_id)}} >Accept</Button>
                            </Link>
                            <Link>
                                <Button style={{marginLeft : '2vw'}} variant="danger" onClick={() => {deleteRequest(element.user_id)}} >Delete</Button>
                            </Link>
                            </li>
                               )  })}
                          ...
                          return (
                            <li className="sidebarFriend" key={index}>
                              ...
                              { groups.user_id === current_ID ?
                                    <Link>
                                        <Button style={{marginLeft : '10.5vw'}} variant="danger" onClick={() => {deleteFromGroup(element.user_id)}} >Delete</Button>
                                    </Link>
                                : "" }
                            </li>
                               )  })}
